...
const About = () => {
  ...
  const benefits = [
    "Développement efficace et structuré selon les meilleures pratiques",
    "Intégration fluide avec vos outils et workflows",
    "Collaboration transparente et réactive",
    "Adaptabilité aux évolutions et aux nouvelles technologies"
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          */}
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Développeur logiciel orienté backend, je conçois des solutions robustes, évolutives et adaptées aux besoins métiers.
              Fort d'une expérience sur les architectures distribuées et une large palette technologique, j’interviens principalement
              sur la partie back-end, tout en restant à l’aise avec le front-end et le mobile lorsque nécessaire.
            </p>
            <p>
              J’ai travaillé avec plusieurs langages et frameworks (Java/Spring Boot, PHP/Laravel, Symfony, CodeIgniter),
              manipulé divers systèmes de bases de données (PostgreSQL, MySQL, MongoDB, Neo4j), et conçu des API REST robustes et sécurisées
              pour des applications performantes et maintenables.
            </p>

            <h4 className="text-xl font-semibold mt-8 mb-4">Ce que je propose</h4>
            <p>
              Que ce soit pour développer une application web, faire évoluer une infrastructure existante ou intégrer de nouvelles technologies,
              j’apporte une approche rigoureuse, technique et orientée résultats.
            </p>
            <p>
              J’accompagne également des indépendants et petites structures dans la création de sites vitrines ou la mise en place de solutions
              professionnelles (hébergement, adresses mail, performances), avec des offres simples, claires et sur mesure.
            </p>

            <h4 className="text-xl font-semibold mt-8 mb-4">Pourquoi travailler avec moi ?</h4>
            ...
            <p className="mt-6">
              📩 <strong>Besoin d’un accompagnement tech ?</strong> Discutons de votre projet !
            </p>
